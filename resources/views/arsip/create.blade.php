    ...
    <div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <form action="{{ route('arsip.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="kode_arsip" name="kode_arsip" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" value="{{ old('kode_arsip') }}" required>
                @error('kode_arsip')
            ...
            <div class="mb-4">
                ...
                <input type="text" id="judul" name="judul" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" value="{{ old('judul') }}" required>
                @error('judul')
                    <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea id="deskripsi" name="deskripsi" rows="3" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('deskripsi') }}</textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <select id="jenis_arsip" name="jenis_arsip" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
            ...
            <div class="mb-4">
                ...
                <input type="date" id="tanggal" name="tanggal" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500" value="{{ old('tanggal') }}" required>
                @error('tanggal')
                    <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="file" id="file" name="file" class="w-full border-gray-300 rounded-lg p-2 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">

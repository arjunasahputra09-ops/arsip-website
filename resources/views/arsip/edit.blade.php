    ...
    <div class="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg">
        ...
        <form action="{{ route('arsip.update', $arsip->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="kode_arsip" name="kode_arsip" class="w-full rounded-lg shadow-sm border-gray-300" value="{{ old('kode_arsip', $arsip->kode_arsip) }}" required>
                @error('kode_arsip')
            ...
            <div class="mb-4">
                ...
                <input type="text" id="judul" name="judul" class="w-full rounded-lg shadow-sm border-gray-300" value="{{ old('judul', $arsip->judul) }}" required>
                @error('judul')
                    <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea id="deskripsi" name="deskripsi" rows="3" class="w-full rounded-lg shadow-sm border-gray-300">{{ old('deskripsi', $arsip->deskripsi) }}</textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="date" id="tanggal" name="tanggal" class="w-full rounded-lg shadow-sm border-gray-300" value="{{ old('tanggal', $arsip->tanggal->format('Y-m-d')) }}" required>
                @error('tanggal')
                    <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                @enderror
            </div>
